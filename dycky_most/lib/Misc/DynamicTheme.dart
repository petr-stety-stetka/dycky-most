...
/// DynamicTheme with fixed default dark theme
...
class DynamicThemeState extends State<DynamicTheme> {
  ...
  Future<bool> loadBrightness() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    //Fix for default dark theme:
    return (prefs.getBool(_sharedPreferencesKey) ?? (widget.defaultBrightness == Brightness.dark ? true : false));
  }
}
